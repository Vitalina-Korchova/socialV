            ...
            <div className="flex justify-between flex-row md:flex-col space-x-1.5 md:space-x-0 md:space-y-1.5 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
              {[
                ...
                >
                  ...
                  {activeTab === tab.id && (
                    <div className="absolute left-0 bottom-0 md:left-0 md:top-1/2 md:-translate-y-1/2 w-full h-[2px] md:w-[3px] md:h-5 bg-purple-500 rounded-t-full md:rounded-r-full shadow-[0_0_10px_rgba(168,85,247,0.5)]" />
                  )}
                </Button>
              ))}
            </div>
